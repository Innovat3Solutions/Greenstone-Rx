      ...
      <div className="flex items-center justify-center gap-8 mt-8">
        <div className="flex items-center gap-3">
          <div className="relative">
            <div className="w-5 h-5 rounded-full bg-gradient-to-br from-green-400 via-green-500 to-green-700 border-2 border-white shadow" />
            <div className="absolute inset-0 w-5 h-5 rounded-full bg-green-500 opacity-30 animate-ping" />
          </div>
          <span className="text-sm text-gray-600 font-medium">Licensed States (28)</span>
        </div>
        <div className="flex items-center gap-3">
