    ...
    <div className="min-h-screen bg-white pt-24 sm:pt-32 pb-16 sm:pb-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-8">
        ...
        <div className="mb-10 sm:mb-16">
          <p className="text-brand-green-dark text-sm font-semibold tracking-wider uppercase mb-3 sm:mb-4">Services</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-gray-200 rounded-2xl sm:rounded-3xl overflow-hidden mb-16 sm:mb-24">
          {services.map((service, index) => (
            <div
              key={service.title}
              className="group bg-white p-6 sm:p-10 hover:bg-gray-50 transition-colors duration-300 relative"
            >
              {/* Service Number */}
              <span className="absolute top-4 right-4 sm:top-8 sm:right-8 text-4xl sm:text-5xl font-display font-light text-gray-100 group-hover:text-brand-green-light/30 transition-colors">
                0{index + 1}
              </span>

              {/* Icon */}
              <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-gradient-to-r from-brand-green-light via-brand-green-primary to-brand-green-dark flex items-center justify-center mb-4 sm:mb-6">
                <service.icon className="w-4 h-4 sm:w-5 sm:h-5 text-white" />
              </div>

              {/* Title */}
              <h3 className="text-lg sm:text-xl font-semibold font-display mb-3 sm:mb-4 text-gray-900 relative z-10">
                {service.title}
              </h3>

              {/* Description */}
              <p className="text-gray-500 text-xs sm:text-sm leading-relaxed mb-4 sm:mb-6 relative z-10">
                {service.description}
              </p>
              ...
              <div className="flex flex-wrap gap-1.5 sm:gap-2 relative z-10">
                {service.features.slice(0, 2).map((feature) => (
                  <span
                    key={feature}
                    className="px-2 sm:px-3 py-1 bg-gray-100 text-gray-600 text-[10px] sm:text-xs font-medium rounded-full group-hover:bg-brand-green-dark/10 group-hover:text-brand-green-dark transition-colors"
                  >
                    {feature}
                  </span>
                ))}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 mb-16 sm:mb-24">
          <div className="relative rounded-xl sm:rounded-2xl overflow-hidden h-[280px] sm:h-[400px]">
            <img
            ...
            <div className="absolute bottom-4 sm:bottom-8 left-4 sm:left-8 right-4 sm:right-8">
              <div className="flex items-center gap-2 sm:gap-3 mb-4">
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-white/90 flex items-center justify-center">
                  <Shield className="w-4 h-4 sm:w-5 sm:h-5 text-brand-green-dark" />
                </div>
                <span className="text-white font-medium text-sm sm:text-base">USP 795 & 797 Compliant</span>
              </div>
            </div>
          </div>

          <div>
            <p className="text-brand-green-dark text-sm font-semibold tracking-wider uppercase mb-3 sm:mb-4">Expertise</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
              {clinicalExpertise.map((item) => (
                <div key={item} className="flex items-start gap-2 sm:gap-3">
                  <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-brand-green-primary flex-shrink-0 mt-0.5" />
        ...
        <div className="rounded-2xl sm:rounded-3xl p-6 sm:p-12 md:p-16 relative overflow-hidden">
          {/* Background Image */}
          <div
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            <div>
              <p className="text-brand-green-light text-sm font-semibold tracking-wider uppercase mb-3 sm:mb-4">Support</p>
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-medium font-display mb-4 sm:mb-6 text-white">
              ...
              <Link
                to="/contact"
                className="inline-flex items-center gap-2 bg-white text-brand-green-dark px-5 sm:px-6 py-2.5 sm:py-3 rounded-full font-medium hover:bg-gray-100 transition-colors text-sm sm:text-base"
              >
                Contact Us
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
              {practiceSupport.map((item) => (
                <div key={item} className="bg-white/10 backdrop-blur-sm rounded-lg sm:rounded-xl p-3 sm:p-4 border border-white/10">
                  <div className="flex items-start gap-2 sm:gap-3">
                    <CheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-brand-green-light flex-shrink-0 mt-0.5" />
        ...
        <div className="text-center mt-16 sm:mt-24">
          ...
          <div className="flex flex-row justify-center gap-3 sm:gap-4">
            <Link
              to="/shop"
              className="bg-gradient-to-r from-brand-green-light via-brand-green-primary to-brand-green-dark text-white px-5 sm:px-8 py-3 sm:py-4 rounded-full font-medium hover:opacity-90 transition-opacity text-sm sm:text-base"
            >
              Products
            </Link>
            <Link
